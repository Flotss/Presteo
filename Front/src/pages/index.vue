<template>
  <section id="hero" class="pt-12 pb-20 px-4">
        <div class="container mx-auto">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="space-y-8">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                        Home Services, <span class="text-blue-600">Simplified</span> and Trustworthy
                    </h1>
                    ...
                    <div id="features" class="grid grid-cols-2 gap-6 mt-12">
                        ...
                        <div class="flex items-start space-x-3">
                          <font-awesome-icon :icon="['fas', 'star']" class="text-blue-600 text-xl mt-2 w-6" />
                            <div>
                                <h3 class="font-semibold">Verified Providers</h3>
                                <p class="text-gray-600">Trusted professionals</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            <font-awesome-icon :icon="['fas', 'location-dot']" class="text-blue-600 text-xl mt-2 w-6" />
                            <div>
                                <h3 class="font-semibold">Service Tracking</h3>
                ...
                <div class="relative">
                    <img class="rounded-2xl shadow-2xl" src="https://cdn.shopify.com/s/files/1/0530/6636/7145/files/stratoss_craftsman_cutting_leather_in_a_white_and_very_clean_wo_c4a901cd-3452-45a7-b394-ec883790bfa5_1024x1024.png?v=1704449205" alt="professional plumber in blue uniform smiling while fixing sink, modern kitchen background, high quality professional photo">
                </div>
            </div>
...
const customers: TerimonialCustomer[] = [
  {
    Name: 'Sarah Johnson',
    stars: 5,
    message: 'Found an amazing electrician through Presteo. Quick booking, professional service, and competitive pricing. Highly recommended!',
  },
  {
    Name: 'Michael Chen',
    stars: 4,
