    ...
    <div class="flex items-center space-x-4 mb-4">
      ...
      <div>
        ...
        <div class="text-yellow-400 flex space-x-1">
          <div v-html="star" v-for="n in stars" :key="'filled-' + n"></div>
          <div v-html="starEmpty" v-for="n in 5 - (stars ?? 5)" :key="'empty-' + n"></div>
        </div>
      </div>
    </div>
